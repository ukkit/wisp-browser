...
This repo is currently built and verified against **LibreWolf `154.0.1-3`** (BuildID `20260827090943`). A newer LibreWolf release may need overlay adjustments — review the overlay files before assuming a newer build works unmodified.
